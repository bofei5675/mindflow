...
tags: [VLN, VLA, SLAM, scene-graph, flow-matching, hierarchical-planning, mobile-manipulation]
status: raw
...
- [[Gu2024-ConceptGraphs]] — Open-vocabulary 3D scene graph，shared representation 的核心技术
- [[Liu2024-OKRobot]] — Modular Nav+Manip baseline，使用 separate representations（对比基线）
- [[Torne2026-MEM]] — 多尺度记忆机制（视频短期 + 语言长期），memory 设计的参考
- [[An2024-ETPNav]] — Hierarchical navigation with explicit topological planning
- [[Huang2023-VLMaps]] — Language-indexed spatial features for navigation
