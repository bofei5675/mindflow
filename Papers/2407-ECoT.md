...
## Connections
- Related papers: [[2406-OpenVLA|OpenVLA]]（ECoT 的基础模型），[[2307-RT2|RT-2]]（55B VLA baseline），[[2405-Octo|Octo]]（另一个被对比的 generalist policy），[[2502-OpenVLA-OFT|OpenVLA-OFT]]（OpenVLA 的后续优化），[[2412-RoboVLMs|RoboVLMs]]（VLA 设计空间分析），[[2204-SayCan|SayCan]]（早期 LLM→robot grounding 工作）
- Related ideas: Chain-of-thought reasoning for embodied agents, visual grounding for robot control, synthetic data generation for robotics
- Related projects:
